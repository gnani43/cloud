                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="payment-option">
                                        <ul class=" list-unstyled">
                                            ...
                                            <li>
                                                <label class="custom-control custom-radio  m-b-20">
                                                    <input name="mod" id="radioStacked1" checked value="UPI" type="radio" class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">UPI</span>
                                                </label>
                                            </li>
                                        </ul>
